...
| `monk-io/monk-actions/build-images@v1` | Build and push all images declared in `MANIFEST` to the per-cluster registry |
| `monk-io/monk-actions/deploy@v1` | Deploy a workload to a provisioned capsule |
